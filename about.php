...
?>
  <section class="main swiper mySwiper">
    <div class="wrapper swiper-wrapper">
      ...
      <img src="uploaded_img/<?php echo $row['first_pic']; ?>" alt="img" class ="image"/>

        <div class="image-data translucent-card">
          <h1 style="color: white;">About Us</h1>

          <h2></span><?php echo $row['main_title']; ?></h2>
          <!-- We are JamCris Trading <br>& <span>Machine Surplus -->
      ...
      <div class="slide swiper-slide">
      <img src="uploaded_img/<?php echo $row['second_pic']; ?>" alt="img" class ="image"/>
        <div class="image-data translucent-card">
          <h1 style="color: white;">About Us</h1>
          <h2><span><?php echo $row['second_title']; ?></span></h2>
          </h2>
      ...
      <div class="slide swiper-slide">
      <img src="uploaded_img/<?php echo $row['third_pic']; ?>" alt="img"class ="image"/>
        <div class="image-data translucent-card">
          <h1 style="color: white;">About Us</h1>
          <h2><span><?php echo $row['third_title']; ?></span></h2>
